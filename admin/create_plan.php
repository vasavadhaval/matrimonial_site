...
if (isset($_POST['submit'])) {
    ...
    // Default Image Path
    $plan_image = "uploads/default.png";
    ...
    $sql = "INSERT INTO plans (plan_name, plan_price, plan_type, plan_image, plan_include1, plan_include2, plan_include3, plan_include4, is_active)
            VALUES ('$plan_name', '$plan_price', '$plan_type', '$plan_image', '$plan_include1', '$plan_include2', '$plan_include3', '$plan_include4', '$is_active')";

    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('Plan Created Successfully'); window.location.href='plan_list.php';</script>";
    } else {
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Plans /</span> Create Plan</h4>
                        <div class="app-ecommerce">
                            <form method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <!-- Left Column: Plan Basic Details -->
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="plan_name" class="form-control"
                                                        name="plan_name" placeholder="Enter Plan Name" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="plan_price">Plan Price</label>
                                                    <input type="number" id="plan_price" class="form-control"
                                                        name="plan_price" placeholder="Enter Plan Price" required>
                                                </div>
                                                <!-- Plan Type Dropdown -->
                                                <div class="mb-3">
                                    ...
                                    <!-- Right Column: Plan Type & Includes -->
