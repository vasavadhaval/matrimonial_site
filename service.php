...
<section class="section service-area bg-gray overflow-hidden ptb_1001 mt-5">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="service-text pt-4 pt-lg-0">
                            <div class="about_taital_box">
                                <h1 class="about_taital">SEARCH TO YOUR CHOICE PARTNER</h1>
                                <h1 class="about_taital_1">marriage beauro</h1>
        ...
        <section class="section discover-area overflow-hidden ptb_1001">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-12 col-lg-6 order-1 order-lg-2">
                        ...
                        <div class="discover-text pt-4 pt-lg-0">
                            <div class="about_taital_box">
                                <h1 class="about_taital"> Professional Guidance </h1>
                                <h1 class="about_taital_1">marriage beauro</h1>
                                <p class=" about_text">has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editorhas a more-or-less normal distribution of letters, as oppos</p>
                                <div class="readmore_btn"><a href="#">Read More</a></div>
                            </div>
        ...
        <section class="section service-area bg-gray overflow-hidden ptb_1001 ">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-lg-6">
                        <!-- Service Text -->
                        <div class="service-text pt-4 pt-lg-0">
                            <div class="about_taital_box">
                                <h1 class="about_taital">Facilitation of Communication</h1>
                                <h1 class="about_taital_1">marriage beauro</h1>
                                <p class=" about_text">has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editorhas a more-or-less normal distribution of letters, as oppos</p>
                                <div class="readmore_btn"><a href="#">Read More</a></div>
                            </div>
