        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-12 col-lg-6">
                ...
                <div class="service-text pt-4 pt-lg-0">
                    <h2 class="promo-text mb-4">PROFESSIONAL GUIDANCE</h2>
                    <p class="mb-4">
                        Has a more-or-less normal distribution of letters, as opposed to using 
                        'Content here, content here', making it look like readable English. Many 
                        desktop publishing packages and web page editor has a more-or-less 
                    ...
                    <ul class="service-list">
                        ...
                        <li class="single-service media py-2">
                            ...
                            <div class="service-text media-body">
                                <p>Expert advice from industry professionals.</p>
                            </div>
                        </li>
                        <!-- Single Service -->
                        <li class="single-service media py-2">
                            <div class="feature-icon text-primary align-self-center pr-4">
                                <span><i class="fas fa-lightbulb fa-2x"></i></span>
                            </div>
                            <div class="service-text media-body">
                                <p>Innovative strategies for career and business growth.</p>
                            </div>
                        </li>
                        <!-- Single Service -->
                        <li class="single-service media py-2">
                            <div class="feature-icon text-primary align-self-center pr-4">
                                <span><i class="fas fa-handshake fa-2x"></i></span>
                            </div>
                            <div class="service-text media-body">
                                <p>Personalized mentoring and support.</p>
                            </div>
                        </li>
                    </ul>
                </div>
