        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-12 col-lg-6">
                ...
                <div class="service-text pt-4 pt-lg-0">
                    <h2 class="promo-text mb-4">FACILITATION OF COMMUNICATION</h2>
                    <p class="mb-4">
                    ...
                    <ul class="service-list">
                        ...
                        <li class="single-service media py-2">
                            ...
                            <div class="service-text media-body">
                                <p>Enhancing interpersonal and business communication.</p>
                            </div>
                        </li>
                        <!-- Single Service -->
                        <li class="single-service media py-2">
                            <div class="feature-icon text-primary align-self-center pr-4">
                                <span><i class="fas fa-globe fa-2x"></i></span>
                            </div>
                            <div class="service-text media-body">
                                <p>Bridging global communication gaps effectively.</p>
                            </div>
                        </li>
                        <!-- Single Service -->
                        <li class="single-service media py-2">
                            ...
                            <div class="service-text media-body">
                                <p>Providing seamless messaging and collaboration tools.</p>
                            </div>
                        </li>
                    </ul>
                </div>
